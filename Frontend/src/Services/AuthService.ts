...
class AuthService {
    ...
    public async register(user: UserModel): Promise<void> {
        ...
        const response = await axios.post<string>(appConfig.registerUrl, user); // JWT
    ...
    public async login(credentials: CredentialsModel): Promise<void> {
        ...
        const response = await axios.post<string>(appConfig.loginUrl, credentials); // Using "post for security reasons"
